...
export function ChallengeDetailPage() {
  ...
  const joined      = (challenge.participants ?? []).some(p => p.userId === userId)
  ...
  return (
    <div className="page-wrapper space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}
        ...
        {sortedPart.length === 0 ? (
          <div className="py-10 text-center text-slate-500 text-sm">No participants yet. Be the first to join!</div>
        ) : (
